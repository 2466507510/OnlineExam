		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="courseAction" action="${path }/addCourse" method="post">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								 <button type="button" class="btn btn-primary" id="courseSub">提交 </button>
							</div>
						</div>
					</form>
				</div>
