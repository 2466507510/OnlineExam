		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="courseAction" action="${path }/updateClass" method="post">
						<div class="form-group">
							<label for="classId" class="col-sm-2 control-label">班级编号</label>
							<div class="col-sm-5">
								<input class="form-control" id="classId" name="classId" type="text" value="${classId }" readonly="readonly" onfocus='this.blur()' />
							</div>
						</div>
						<div class="form-group">
						...
						<div style="display: none">
							<input type="text" id="oldTeacherId" name="oldTeacherId" value="${oldTeacherId }">
						</div>
						<br />
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-4">
								 <button type="button" class="btn btn-primary" id="updateClassSub">提交 </button>
							</div>
						</div>
					</form>
				</div>
